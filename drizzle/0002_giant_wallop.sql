...
CREATE TABLE `__new_compiledItems` (
	...
	`createdAt` integer DEFAULT '"2026-01-12T23:16:04.946Z"' NOT NULL,
...
CREATE TABLE `__new_runArchives` (
	...
	`archivedAt` integer DEFAULT '"2026-01-12T23:16:04.947Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_runs` (
	...
	`userId` integer NOT NULL,
	`status` text DEFAULT 'draft' NOT NULL,
	`startedAt` integer DEFAULT '"2026-01-12T23:16:04.946Z"' NOT NULL,
	`completedAt` integer,
	`stats` text NOT NULL,
	`createdAt` integer DEFAULT '"2026-01-12T23:16:04.946Z"' NOT NULL,
	`updatedAt` integer NOT NULL
...
CREATE TABLE `__new_users` (
	...
	`createdAt` integer DEFAULT '"2026-01-12T23:16:04.945Z"' NOT NULL,
	`updatedAt` integer,
	`lastSignedIn` integer DEFAULT '"2026-01-12T23:16:04.946Z"' NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE `userSettings` ADD `aiProviders` text DEFAULT '{}' NOT NULL;--> statement-breakpoint
ALTER TABLE `userSettings` ADD `aiPreferences` text DEFAULT '{}' NOT NULL;